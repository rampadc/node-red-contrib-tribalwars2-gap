        ...
        copy: {
            ...
            release: {
                files: [{
                    ...
                    dest: path.resolve('<%= paths.dist %>/node-red')
                }]
            }
        },
        chmod: {
            ...
            release: {
                src: [
                    path.resolve('<%= paths.dist %>/node-red/nodes/core/hardware/nrgpio*'),
                    path.resolve('<%= paths.dist %>/node-red/red/runtime/storage/localfilesystem/projects/git/node-red-*sh')
                ]
            }
        },
        compress: {
            release: {
                options: {
                    archive: '<%= paths.dist %>/node-red.zip'
                },
                expand: true,
                cwd: '<%= paths.dist %>/',
                src: ['node-red/**']
